...
public class Soy extends CondimentDecorator {
     ...
     * but also each item decorating the beverage (for instance, "Dark Roast, Soy").
    ...
    /***
     * We need to compute the cost of our beverage with Soy.
     * First, we delegate the call to the object we're decorating
     * so that it can compute the cost; then, we add the cost of
     * Soy to the result.
     * @return the cost of the beverage include the cost of the decorator(Soy).
     */
    @Override
    public double cost() {
